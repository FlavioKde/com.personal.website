...
const Sidebar = ({ openTab, isOpen, closeSidebar }) => {
  return (
    <>
      {/* Mobile Overlay */}
      {isOpen && (
      ...
      <aside className={cn(
        'w-64 fixed top-10 left-0 shadow-lg z-50 h-[calc(100vh-2.5rem)] overflow-y-auto border-r border-neutral-800 transition-transform duration-300 ease-in-out',
